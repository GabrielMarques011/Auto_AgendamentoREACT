    ...
    <div className="w-full max-w-3xl mx-auto">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">
          Informe Data e Período
        </h2>
        <p className="text-gray-600">
          Selecione a data e o período para agendamento do serviço
        </p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onBlur={handleValidateDate} // valida apenas quando o usuário termina de digitar
          ...
          <small className="block mt-1.5 text-sm text-gray-500">
            Escolha a data desejada para a visita técnica (até 2 anos à frente)
          </small>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 mt-1">
                  Data:{" "}
                  {new Date(formData.scheduledDate + "T00:00:00").toLocaleDateString(
                    "pt-BR"
                  )}{" "}
                  - Período:{" "}
                  {formData.period.charAt(0).toUpperCase() +
